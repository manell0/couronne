"""
Django settings for couronne project.
...
# SECRET_KEY = 'django-insecure-r!^mqseqy5^!x%vlc7oa$^8w(=6n1_-w4@ni^#o5^_8fs8bc1c'
...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',
    'allauth.socialaccount',  # social media providers like Facebook and Google
    # My apps
    'home',
    'donate',
    # Other
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'manello-couronne'
